...
\begin{tikzpicture}
    ...
    \caption{Trapezoidal membership functions for grades C and B with the overlapping region shaded. Scores near 78--82 partially satisfy both grade definitions. This overlap design keeps boundary cases smooth instead of forcing abrupt label switches.}
