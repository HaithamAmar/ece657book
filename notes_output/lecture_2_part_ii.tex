...
\Cref{chap:symbolic} illustrated one view of intelligent behavior as transformation search with explicit goal tests, while \Cref{chap:supervised} introduced the data-driven view: represent a task with data, choose a hypothesis class, minimize empirical risk under regularization, and audit performance on held-out data. This chapter extends that toolkit from regression to classification. \Cref{fig:roadmap} places this chapter on the core supervised path.
...
Use \Cref{fig:lec1_dataset} as the diagnostic anchor for this section.

\Cref{fig:lec2_sigmoid_bce} is the compact geometry reference for logits, BCE, and regularization strength.
...
Use \Cref{fig:lec1_bayes} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec2_sigmoid_bce} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_gd} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec2-logistic-boundary} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_mle_map} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1-roc-pr} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_confusion} as the diagnostic anchor for this section.
