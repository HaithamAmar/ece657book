...
Before writing the first equation, fix the convention: examples are row vectors, weights multiply on the right, and in mini\hyp{}batches the bias is broadcast across rows.
