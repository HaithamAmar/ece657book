...
\begin{itemize}
  ...
  \item Choose losses and metrics deliberately (e.g., cross-entropy vs.\ mean squared error (MSE); accuracy vs.\ calibration) for CNN-based models.
  ...
  \item Describe practical stabilizers (batch normalization (BN), dropout, weight decay, optimizers) and the failure signatures they address.
\end{itemize}
\end{tcolorbox}
