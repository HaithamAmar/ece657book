...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        \end{groupplot}
    \end{tikzpicture}
    \caption{Batch normalization normalizes per-channel activations and then applies a learned scale and shift, which stabilizes training by keeping activation scales in a reasonable range.}
    \label{fig:lec6-bn}
\end{figure}
