...
An image is naturally a 2D array (or a 3D tensor with channels). For example, a single-channel (grayscale) image of size $256 \times 256$ pixels can be represented as a matrix:
\[
