...
\label{sec:cnn_overview_of_neural_network_architectures}
...
\label{sec:cnn_feedforward_neural_networks_multi_layer_perceptrons_sub}
...
\label{sec:cnn_why_shallow_networks_are_insufficient}
...
\label{sec:cnn_limitations_of_traditional_feedforward_neural_networks}
...
\label{sec:cnn_challenges_in_training_large_fully_connected_networks}
...
\label{sec:cnn_deep_network_optimization_challenges_sec_cnn_deep_network_optimization_challenges}
