...
\Cref{chap:symbolic} illustrated a non-statistical lens: solve problems by transformation search, with explicit goal tests. We now switch to the data-driven lens. \Cref{fig:roadmap} marks this as the core supervised strand.
...
Use \Cref{fig:lec1_fit_regimes} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_l1_l2_geometry} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_lasso_path} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_class_losses} as the diagnostic anchor for this section.

\Cref{fig:lec1_reg_losses} is the regression-loss comparison referenced in this section.
...
Use \Cref{fig:lec1_reg_losses} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_splits} as the diagnostic anchor for this section.
...
\Cref{fig:lec1_splits} is the split protocol reference for the train/validation/test workflow.
...
Use \Cref{fig:lec1_pipeline} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1_learning_curves} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec1-calibration-double-descent} as the diagnostic anchor for this section.
