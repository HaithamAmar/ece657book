...
\medskip
\paragraph{Where we head next.} \Cref{chap:softcomp} steps away from neural sequence models to review the broader soft-computing toolkit (fuzzy logic and evolutionary ideas) previewed in \Cref{chap:intro}. If you want the embedding objectives and deployment/audit checklist that pair naturally with language modeling, see \Cref{chap:nlp}.
