...
\paragraph{Notation.} Throughout this chapter we use the operator defaults stated in the box above. When we introduce a general t\hyp{}norm \(T\), it appears explicitly (e.g., in \eqref{eq:extension-two-var} and \eqref{eq:composition_general}). For symbol overloads when reading across parts, see \Cref{app:notation_collisions}.
