...
Use \Cref{fig:lec10-extension} as the derivation anchor for this section.

\Cref{fig:alpha-cut-nonmonotone} is the non-monotone alpha-cut reference used when discussing piecewise image mapping.
...
Use \Cref{fig:alpha-cut-nonmonotone} as the derivation anchor for this section.

\Cref{fig:lec17_projection_matrix} is the projection-table reference for the relation-to-marginal mapping step.
...
Use \Cref{tab:tnorms} as the derivation anchor for this section.
...
Use \Cref{fig:lec17_projection_matrix} as the derivation anchor for this section.
