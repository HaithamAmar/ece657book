...
\begin{itemize}
    ...
    \item \textbf{XOR with two hidden units:} Train a tiny multi-layer perceptron (MLP) on XOR and plot its decision regions; note sensitivity to initialization and step size.
\end{itemize}
\medskip
