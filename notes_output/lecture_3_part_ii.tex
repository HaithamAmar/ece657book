...
\begin{tcolorbox}[summarybox,title={A short map: building a trainable network}]
...
Use \Cref{fig:mlp_minimal_chain} as the derivation anchor for this section.
...
\Cref{fig:mlp_gd_surface} is the optimization-geometry reference for vector versus coordinate updates.
...
Use \Cref{fig:mlp_gd_surface} as the derivation anchor for this section.

\Cref{fig:mlp_step_vs_sigmoid} is the activation-smoothness reference used to motivate differentiable training.
...
Use \Cref{fig:mlp_step_vs_sigmoid} as the derivation anchor for this section.
