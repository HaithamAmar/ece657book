...
\end{equation}
where $\mathbf{r}_i$ denotes the grid coordinates of neuron $i$ and $\sigma(t)$ is the neighborhood radius that decreases monotonically with $t$. A common schedule (as in the lecture handnotes) is an exponential decay:
\begin{equation}
