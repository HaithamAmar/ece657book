...
\Cref{chap:rbf} offered a nonlinearity that stays close to linear algebra (basis expansion + linear solve). Here we switch to an unsupervised lens: self-organizing maps discover prototypes and organize them on a lattice without labels. Figure \Cref{fig:roadmap} highlights this as the competitive/unsupervised branch.
