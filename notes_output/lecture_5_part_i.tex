...
\begin{itemize}
    ...
    \item \(h_{ci}(t)\) is the neighborhood function centered on the winning neuron \(c\), typically a Gaussian kernel that decreases with the lattice distance between neurons \(c\) and \(i\) (see \eqref{eq:gaussian_neighborhood_short}).
\end{itemize}
