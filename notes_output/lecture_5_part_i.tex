...
\Cref{chap:rbf} offered a nonlinearity that stays close to linear algebra (basis expansion + linear solve). Here we switch to an unsupervised lens: self-organizing maps discover prototypes and organize them on a lattice without labels. \Cref{fig:roadmap} highlights this as the competitive/unsupervised branch.

This chapter opens the unsupervised neural thread with \emph{Self-Organizing Maps} (SOMs), also known as Kohonen maps. \Cref{chap:hopfield} then studies Hopfield networks, an energy-based associative memory model. Both operate without explicit targets, in contrast to the supervised ERM pipeline in \Cref{chap:supervised}.
...
Use \Cref{fig:lec5-learning-rate} as the diagnostic anchor for this section.

\Cref{fig:lec5-som-component-planes} is the feature-plane audit reference paired with U-Matrix diagnostics.
...
Use \Cref{fig:lec5-mds-projection} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-gaussian-neighborhood} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-bias-variance} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-regularization} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-crossentropy} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-early-stopping} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-softmax-regions} as the diagnostic anchor for this section.
...
Use \Cref{fig:lec5-som-component-planes} as the diagnostic anchor for this section.
...
Use \Cref{fig:som_neighborhood} as the diagnostic anchor for this section.
