...
\begin{itemize}
  ...
  \item \textbf{Unifying lens:} this Part fixes the representation and feedback signal, and the rest is choosing an update rule plus audits that prevent silent failure.
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item \textbf{Loop emphasis:} relative to \Cref{fig:unified_contract_loop}, this part mostly stresses the \emph{update} box --- gradient flow, masking, normalization, and optimizer stability determine whether the representation can actually be learned.
...
\begin{itemize}
  ...
  \item \textbf{Loop emphasis:} relative to \Cref{fig:unified_contract_loop}, this part shifts pressure toward the \emph{representation} and \emph{audit} boxes --- the memberships, operators, and rule base are the model, so units, overlaps, and edge-case checks matter early.
...
\begin{itemize}
  ...
  \item \textbf{Loop emphasis:} relative to \Cref{fig:unified_contract_loop}, this part changes the \emph{update} box most sharply --- gradients disappear and the update becomes selection, mutation, crossover, and constraint handling under a fixed evaluation budget.
...
\begin{itemize}
  ...
  \item \textbf{Unifying lens:} this Part removes the gradient and asks what discipline is needed when feedback is noisy, sparse, or available only as a fitness rank.
\end{itemize}
\end{tcolorbox}
