...
\paragraph{Where we head next.} \Cref{chap:evo} shifts from fuzzy controllers to evolutionary computing, where population-based search and optimization heuristics form the other major soft-computing pillar. Read it as a tuning companion to this trilogy: once you can audit a fuzzy pipeline, evolutionary search becomes a principled way to tune memberships, rule weights, or operator parameters when hand-tuning becomes brittle.
