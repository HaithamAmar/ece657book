...
\begin{enumerate}
  \item \textbf{Fuzzification layer.} Each node computes the membership degree \(\mu_{A_i}(x_1)\) or \(\mu_{B_j}(x_2)\) using trainable membership function parameters (e.g., Gaussian centres and widths).
