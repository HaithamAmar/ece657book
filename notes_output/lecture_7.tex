...
Given a training sequence \( (w_1, w_2, \ldots, w_T) \), we typically train by minimizing the negative log-likelihood (equivalently, maximizing the likelihood). With the next-token convention, the loss is
\begin{equation}
