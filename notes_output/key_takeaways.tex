...
\begin{figure}[!hb]
    ...
    \end{tikzpicture}
    \end{adjustbox}
    \caption[Map of model families]{Color\hyp{}coded map of model families across agent level, model nature, and learning signal, highlighting where each family sits in the taxonomy and where to read next.}
    \label{fig:big-picture-map}
\end{figure}

\Cref{fig:big-picture-map} provides the visual map; \Cref{tab:big-picture-models} serves as a compact lookup for model-family placement across levels and learning signals.
