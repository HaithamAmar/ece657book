% Internal workflow checklist (NOT included in the published book)
%
% Purpose: after any reordering/splitting/merging, ensure the manuscript remains
% coherent and all cross-references remain correct in both PDF and EPUB builds.
%
% Note: keep this file out of `notes_output/book_appendices.tex`.
\section{Rearrangement QA Checklist}\label{app:rearrangement_qa}

\noindent This checklist is a practical guardrail for any future reordering, splitting, merging, or rewriting of chapters/sections. The goal is to keep the book coherent as a dependency graph while ensuring every cross-reference and numbering-dependent statement remains correct in both PDF and EPUB builds.
