...
After the fuzzy trilogy (\Crefrange{chap:softcomp}{chap:fuzzyinference}), this chapter develops the evolutionary-search strand introduced in \Cref{chap:intro}. The focus shifts from rule composition to population-based optimization under constraints, budgets, and stochastic variability.
