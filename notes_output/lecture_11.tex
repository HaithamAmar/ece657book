...
The GA loop alternates fitness evaluation with selection, crossover, mutation, and replacement until a stopping criterion is met. The flow diagram in \Cref{fig:lec11-ga-flow} and the pseudocode in \Cref{sec:evo_pseudocode_representation} capture the control structure for quick reference.
