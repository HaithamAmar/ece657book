...
\begin{figure}[t]
    ...
    \begin{tikzpicture}[
        panel/.style={draw=gray!42, rounded corners=8pt, fill=gray!4, minimum width=5.45cm, minimum height=4.05cm},
        paneltitle/.style={font=\bfseries\normalsize},
        flow/.style={->, line width=1.1pt, gray!72},
        box/.style={draw=gray!45, rounded corners=4pt, fill=white, minimum width=1.7cm, minimum height=0.56cm, font=\footnotesize, align=center},
        tiny/.style={font=\scriptsize, color=gray!82},
        fitbar/.style={draw=none, fill=cbBlue!55},
        midbar/.style={draw=none, fill=cbBlue!30},
        lowbar/.style={draw=none, fill=cbBlue!15}
    ]
        % Selection panel
        \begin{scope}[shift={(0,0)}]
            \node[panel] at (0,0) {};
            \node[paneltitle] at (0,1.34) {Selection};
            \node[font=\small, anchor=east] at (-1.72,0.56) {fit};
            \node[font=\small, anchor=east] at (-1.72,0.02) {mid};
            \node[font=\small, anchor=east] at (-1.72,-0.52) {low};
            \fill[fitbar] (-1.25,0.30) rectangle (1.55,0.74);
            \fill[midbar] (-1.25,-0.16) rectangle (0.95,0.28);
            \fill[lowbar] (-1.25,-0.62) rectangle (0.28,-0.18);
            \draw[gray!35] (-1.25,0.30) rectangle (1.75,0.74);
            \draw[gray!35] (-1.25,-0.16) rectangle (1.75,0.28);
            \draw[gray!35] (-1.25,-0.62) rectangle (1.75,-0.18);
            \node[tiny, anchor=west] at (1.10,0.52) {high};
            \node[tiny, anchor=west] at (0.50,0.06) {medium};
            \node[tiny, anchor=west] at (-0.12,-0.40) {low};
        \end{scope}

        % Crossover panel
        \begin{scope}[shift={(5.70,0)}]
            \node[panel] at (0,0) {};
            \node[paneltitle] at (0,1.34) {Crossover};
            \node[font=\small, anchor=east] at (-1.88,0.56) {parent A};
            \node[font=\small, anchor=east] at (-1.88,0.04) {parent B};
            \node[font=\small, anchor=east] at (-1.88,-0.82) {child 1};
            \node[font=\small, anchor=east] at (-1.88,-1.34) {child 2};

            \fill[cbBlue!45]   (-1.30,0.34) rectangle (0.35,0.78);
            \fill[cbOrange!35] (0.35,0.34) rectangle (1.75,0.78);
            \draw[gray!40] (-1.30,0.34) rectangle (1.75,0.78);

            \fill[cbOrange!35] (-1.30,-0.18) rectangle (0.35,0.26);
            \fill[cbBlue!45]   (0.35,-0.18) rectangle (1.75,0.26);
            \draw[gray!40] (-1.30,-0.18) rectangle (1.75,0.26);

            \draw[dashed, gray!70] (0.35,0.98) -- (0.35,-0.44);
            \draw[flow] (0.23,-0.46) -- (0.23,-0.68);
            \draw[flow] (0.47,-0.46) -- (0.47,-0.68);

            \fill[cbBlue!45]   (-1.30,-1.04) rectangle (0.35,-0.60);
            \fill[cbBlue!45]   (0.35,-1.04) rectangle (1.75,-0.60);
            \draw[gray!40] (-1.30,-1.04) rectangle (1.75,-0.60);

            \fill[cbOrange!35] (-1.30,-1.56) rectangle (0.35,-1.12);
            \fill[cbOrange!35] (0.35,-1.56) rectangle (1.75,-1.12);
            \draw[gray!40] (-1.30,-1.56) rectangle (1.75,-1.12);

            \node[tiny] at (0.35,0.93) {cut};
        \end{scope}

        % Constraints panel
        \begin{scope}[shift={(2.85,-4.05)}]
            \node[panel] at (0,0) {};
            \node[paneltitle] at (0,1.34) {Constraints};
            \node[box] (cand) at (-1.45,0.20) {candidate};
            \node[draw=gray!45, diamond, aspect=1.8, fill=white, minimum width=1.45cm, minimum height=0.78cm, font=\footnotesize, align=center] (feas) at (0.30,0.20) {feasible?};
            \node[box, fill=cbOrange!18] (repair) at (0.25,-1.08) {repair /\\ penalty};
            \node[box, fill=cbGreen!16] (eval) at (1.95,0.20) {evaluate};
            \draw[flow] (cand.east) -- (feas.west);
            \draw[flow] (feas.east) -- node[above, tiny, pos=0.55] {yes} (eval.west);
            \draw[flow] (feas.south) -- node[right, tiny, pos=0.45] {no} (repair.north);
            \draw[flow] (repair.east) -| (eval.south);
        \end{scope}
    \end{tikzpicture}
    \end{adjustbox}
    \caption{Evolutionary micro-operators. Left: selection increases the sampling rate of fitter candidates. Center: crossover splices parent segments to produce new chromosomes. Right: constraint handling routes candidates through feasibility checks before final evaluation.}
