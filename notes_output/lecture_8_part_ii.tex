...
After completing the neural sequence toolchain---from recurrence in \Cref{chap:rnn} through embeddings in \Cref{chap:nlp} and attention-based modeling in \Cref{chap:transformers}---we pivot to soft computing as the behavioral and evolutionary strand introduced in \Cref{chap:intro}. This chapter opens that strand and establishes the thermostat example used throughout \Crefrange{chap:fuzzysets}{chap:fuzzyinference}.
