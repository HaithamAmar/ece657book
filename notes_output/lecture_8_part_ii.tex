...
\begin{table}[t]
\centering
\caption{Fuzzy vs.\ probabilistic reasoning at a glance. Use it when deciding whether your uncertainty is about randomness (probability) or about graded concepts (fuzziness).}
...
\Cref{tab:boolean-vs-fuzzy} provides a quick translation from crisp logic operators to fuzzy operators.

\begin{table}[t]
\centering
\caption{Boolean operators vs.\ fuzzy operators at a glance. Use it when translating crisp logic rules into graded operators for fuzzy inference.}
