...
\begin{table}[t]
\centering
\caption{Fuzzy vs.\ probabilistic reasoning at a glance. Helps decide whether your uncertainty is about randomness (probability) or graded concepts (fuzziness).}
...
\begin{table}[t]
\centering
\caption{Boolean operators vs.\ fuzzy operators at a glance. A quick translation for turning crisp logic rules into graded operators for fuzzy inference.}
