...
Neural networks, evolutionary search, probabilistic modeling, and fuzzy logic solve different bottlenecks. Neural networks are strongest when enough data exist and predictive accuracy is the main objective; evolutionary methods are effective when the objective is rugged or derivative-free; probabilistic models are strongest when uncertainty calibration is central. Fuzzy logic is the right tool when the specification is linguistic and the decision process must remain transparent. In practice, these are complementary, not competing, components.
