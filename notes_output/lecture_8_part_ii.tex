...
\begin{table}[t]
\centering
\caption{Fuzzy vs.\ probabilistic reasoning at a glance. Use this when deciding whether your uncertainty is about randomness (probability) or about graded concepts (fuzziness).}
...
\begin{table}[t]
\centering
\caption{Boolean operators vs.\ fuzzy operators at a glance. Use this when translating crisp logic rules into graded operators for fuzzy inference.}
