...
\begin{itemize}
    \item Backpropagation is the chain rule organized: cache forward values, propagate \(\delta\)'s backward using \Cref{eq:backprop_delta_recursion}, then assemble gradients with \Cref{eq:grad_W,eq:grad_b}.
