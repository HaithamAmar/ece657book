...
\begin{itemize}
    \item \(\mathbf{A}^{(l-1)}\in\mathbb{R}^{B\times n_{l-1}},\; \mathbf{Z}^{(l)},\delta^{(l)}\in\mathbb{R}^{B\times n_l}\)
    \item \(\mathbf{W}^{(l)}\in\mathbb{R}^{n_{l-1}\times n_l},\; \mathbf{b}^{(l)}\in\mathbb{R}^{n_l}\)
    \item \(\partial L/\partial \mathbf{W}^{(l)} = (\mathbf{A}^{(l-1)})^\top \delta^{(l)} / B \in \mathbb{R}^{n_{l-1}\times n_l}\)
    \item \(\partial L/\partial \mathbf{b}^{(l)} = \mathrm{batch\_mean}(\delta^{(l)}) \in \mathbb{R}^{n_l}\)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Shape assertions:} Verify that \(\mathbf{Z}^{(l)}, \mathbf{A}^{(l)},\delta^{(l)}\) have the expected batch shapes and that bias broadcasts correctly.
...
\delta^{(l-1)} &= \left(\delta^{(l)}(\mathbf{W}^{(l)})^\top\right) \odot \phi^{(l-1)\prime}(\mathbf{Z}^{(l-1)}), \quad l = L, \ldots, 2,
...
\begin{align}
\frac{\partial \mathcal{L}}{\partial \mathbf{W}^{(l)}} &= (\mathbf{A}^{(l-1)})^\top \delta^{(l)}, \label{eq:grad_W}\\
\frac{\partial \mathcal{L}}{\partial \mathbf{b}^{(l)}} &= \mathbf{1}^\top \delta^{(l)}. \label{eq:grad_b}
\end{align}
