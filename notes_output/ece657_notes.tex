...
\usepackage{graphicx}
\graphicspath{{assets/}} % fallback for common figure location
...
\usepackage{microtype}
        ...
        \pagestyle{fancy}
        \fancyhf{}
        % Book-style running heads (twoside): book title on verso, chapter on recto.
        \fancyhead[LE]{\small Modern Intelligent Systems}
        \fancyhead[RO]{\small \nouppercase{\leftmark}}
        \fancyfoot[C]{\thepage}
        \renewcommand{\sectionmark}[1]{%
          \markboth{\thesection\ ---\ \truncate{0.9\textwidth}{#1}}{}}
...
\makeatother
        ...
        \hypersetup{
            pdftitle={Modern Intelligent Systems: A Graduate Companion - Neural Networks, Fuzzy Logic, and Evolutionary Optimization},
