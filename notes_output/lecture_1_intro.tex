...
\begin{figure}[!b]
    ...
    \begin{tikzpicture}[>=Stealth, node distance=1.6cm and 1.8cm]
        ...
        \node[block, right=of rnn] (trf) {Transformers\\(Attention)};
        % Branch: SOM -> Fuzzy
        ...
        \draw[->, gray!60] (fuzzy) to[bend right=20] (trf);
    \end{tikzpicture}%
    }
    \captionsetup{justification=raggedright}
    \caption{Roadmap of the book strands (core supervised path through attention models; SOM/fuzzy; optimization/evolutionary). It also serves as a quick prerequisite map when you want to jump ahead and later backfill foundations.}
    \label{fig:roadmap}
\end{figure}
