...
\begin{figure}[!b]
    ...
    \caption{Roadmap (core supervised path; SOM/fuzzy; optimization/evolutionary). Use this when choosing a reading path and locating prerequisites before jumping ahead.}
    \label{fig:roadmap}
\end{figure}
