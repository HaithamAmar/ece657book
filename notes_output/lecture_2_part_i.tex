...
\begin{figure}[h]
        ...
        \caption{Schematic: Transformation tree for the running example integral; badges \textbf{[S]}/\textbf{[H]} mark safe vs.\ heuristic moves; the dashed branch mirrors the sine substitution. Use this when diagnosing where a solve attempt branched and why backtracking was required.}
