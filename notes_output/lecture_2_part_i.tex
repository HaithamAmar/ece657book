...
\begin{figure}[h]
        ...
        \caption{Transformation tree for the running example integral. Badges \textbf{[S]}/\textbf{[H]} mark safe vs.\ heuristic moves; the dashed branch mirrors the sine substitution. The tree view makes it easy to see where an attempt branched and where backtracking entered.}
