...
The material has since been rewritten to stand alone as a book. Any offering-specific details (schedules, grading, local policies) are intentionally kept out of the published edition; if you are using this text in a course offering, consult the accompanying course handout (or a course-edition build) for those logistics.
